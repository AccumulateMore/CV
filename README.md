...
备注：1. 项目带数据集 2. 可以训练模型 3. 可以画出评估指标图 4. 有可视化UI界面 5. 可以图片、视频、摄像头检测 6. 可以将图片或者视频检测结果保存 7. 另外可以作为毕业论文设计 8. 可以发软件著作（保研、拿国奖等）9. 简历可以多个项目经历 10. 快速从0到1，节省大量时间。
...
备注：项目代码（全套：带数据集训练、带软件界面等），限时价160（吉利数），祝前程似锦~ 
